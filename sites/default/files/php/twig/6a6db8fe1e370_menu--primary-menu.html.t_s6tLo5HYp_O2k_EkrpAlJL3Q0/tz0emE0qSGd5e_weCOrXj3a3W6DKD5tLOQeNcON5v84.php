...
class __TwigTemplate_86b5294b972dac922569265c69f3b944 extends Template
{
...
($context["is_top_level_menu"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp) && (($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129)) && $tmp instanceof Markup ? (string) $tmp : $tmp))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "D:\\Prakash\\Workspace\\ServBay\\www\\csi-church-family\\core\\themes\\olivero\\templates\\navigation\\menu--primary-menu.html.twig");
    }
